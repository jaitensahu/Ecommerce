...
const COUNTDOWN_FROM = "2/15/2024";
...
// console.log(end);
  ...
  return (
    <div className="p-4 w-[94%]  mx-auto bg-gradient-to-br from-violet-600 to-indigo-600 rounded-lg">
        <marquee className="text-white text-3xl">SALE...!!! SALE...!!! SALE...!!! </marquee>
